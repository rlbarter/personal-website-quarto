...
A few short months ago, we each got out of bed, and without knowing it, stepped into a brave new world. A world in which many of the tasks that used to be our day-to-day focus, such as editing, writing, and summarizing documents and code, can now be done by a computer. While we still need to be at the helm, setting the course for these tasks, we no longer need to do all of the minute tasks, like copy-editing, scaling up our code, and summarizing what we did. That's all taken care for us by ChatGPT (and by all of the other software that is looming on the horizon). After writing a rough version of this entire blog post (Without worrying about grammar and wording), I used ChatGPT to smooth it out, probably saving me an hour of minute tasks.

Perhaps, like me, when you first started playing with ChatGPT, you felt an eerie sense of dread start to well up in your chest. A dread that said "*This is it. It's here. Holy crap. What is this world that are we about to step into?*".
